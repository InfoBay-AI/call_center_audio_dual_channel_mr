# call_center_audio_dual_channel_mr
**Dataset Description:**

This dataset is a **large-scale collection of raw Marathi call center audio (dual-channel)**, designed to support the development and training of advanced speech and AI systems.
